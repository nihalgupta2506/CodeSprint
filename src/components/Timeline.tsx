...
const Timeline = () => {
    ...
    const events: TimelineEvent[] = [
        ...
        { date: "10th Apr 2026", title: "Registration Closes", desc: "Last date to register your team" },
        {
            ...
            schedule: [
                { time: "08:00 – 10:00 AM", activity: "Registration Process Starts" },
                { time: "10:00  - 11:00 AM", activity: "Inauguration of TechnoTarang" },
                ...
                { time: "07:30 – 09:30 PM", activity: "Dinner" },
                { time: "09:30 – 11:30 PM", activity: "Cultural Activity 🎭" },
        ...
        },
        {
            ...
            schedule: [
                ...
                { time: "07:00 – 08:00 AM", activity: "Breakfast" },
                { time: "08:30 – 11:30 AM", activity: "Second Round of Assessment" },
                { time: "12:00 – 01:30 PM", activity: "Power Judging – Final Pitch (6 min/team) 🏆" },
                // { time: "01:30 – 02:30 PM", activity: "Lunch Break" },
                { time: "01:30 – 02:30 PM", activity: "Award Ceremony & Closing Ceremony" },
            ],
        },
    ];
