                ...
                >
                    {themes.map((theme, index) => (
                        <motion.div
                            ...
                            className="bg-white border-2 border-blue-100 p-4 md:p-8 rounded-xl hover:border-neon-blue hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center text-center cursor-pointer"
                        >
                            <div className="text-3xl md:text-5xl text-accent-blue mb-3 md:mb-6 group-hover:scale-110 group-hover:text-neon-blue transition-all duration-300">
                                {theme.icon}
                            </div>
                            <h3 className="text-sm md:text-lg font-exo font-bold text-gray-800 group-hover:text-neon-blue transition-colors leading-tight">
                                {theme.title}
                            </h3>
                        </motion.div>
                    ))}
