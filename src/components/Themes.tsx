...
import {
    FaCubes, FaGraduationCap, FaDollarSign, FaRocket,
    FaBitcoin, FaLandmark, FaHeartbeat, FaLeaf,
    FaShieldAlt, FaBus, FaSolarPanel, FaRobot,
    FaRunning, FaPlane, FaGlobeAfrica
} from "react-icons/fa";
...
const themes = [
    {
        icon: <FaCubes />,
        title: "Web 3.0",
        description: "Decentralized platforms, blockchain-based applications, and next-generation internet solutions reshaping the digital landscape.",
    ...
    },
    {
        icon: <FaBitcoin />,
        title: "Bitcoin",
        description: "Cryptocurrency, decentralized finance, and blockchain-based solutions for secure and transparent transactions.",
    ...
    },
    {
        icon: <FaLandmark />,
        title: "Heritage",
        description: "Digital preservation, restoration, and promotion of cultural heritage using modern technology.",
    ...
    },
    {
        icon: <FaLeaf />,
        title: "Ecosystems",
        description: "Biodiversity conservation, waste management, and environmental monitoring to preserve our planet's ecosystems.",
    ...
    },
    {
        icon: <FaShieldAlt />,
        title: "Cybersecurity",
        description: "Protection of digital ecosystems and critical infrastructure from evolving cyber threats.",
    ...
    },
    {
        ...
        description: "Autonomous systems, drones, and robotics driving innovation in agriculture, logistics, and beyond.",
    ...
    },
    {
        icon: <FaRunning />,
        title: "Sports",
        description: "Tech innovations in sports, fitness ecosystems, smart stadiums, and energy-aware wearables.",
    ...
    },
    {
        icon: <FaPlane />,
        title: "Tourism",
        description: "Eco-tourism, responsible travel, and sustainable tourism systems for a greener travel experience.",
    ...
    },
    {
        ...
        description: "Circular economy models and long-term sustainable growth solutions aligned with global development goals.",
...
const Themes = () => {
    ...
    return (
        <section id="themes" className="pt-6 pb-12 md:pt-10 md:pb-20 bg-off-white/70 relative">
