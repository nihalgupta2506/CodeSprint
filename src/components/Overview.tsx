...
const Overview = () => {
    return (
        <section id="overview" className="pt-6 pb-12 md:pt-10 md:pb-20 bg-beige/70 relative">
                ...
                >
                    ...
                    <div className="glass-card p-5 md:p-12 rounded-2xl">
                        <p className="text-lg text-gray-700 leading-relaxed mb-6 font-montserrat text-justify">
                            <span className="font-bold text-secondary-blue">TechnoTarang</span>, a premier National Level Hackathon, is organized by the Departments of Computer Engineering, Information Technology and Advance Computing, in association with PIIC, with the support of the Students’ Council of PCE.
                        </p>
                        <p className="text-lg text-gray-700 leading-relaxed mb-6 font-montserrat text-justify">
