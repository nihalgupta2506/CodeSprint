...
const Sponsors = () => {
    ...
    return (
        <section id="sponsors" className="py-20 bg-beige relative">
                ...
                >
                    {[...Array(8)].map((_, index) => (
                        <motion.div
                            ...
                            className="aspect-square bg-white border border-neon-blue/20 rounded-xl flex flex-col items-center justify-center p-6 hover:border-neon-blue hover:shadow-lg transition-all duration-300 group cursor-pointer"
                        >
                            <span className="text-gray-300 font-bold mb-2">Sponsor Logo</span>
